...
class failedScreenShot extends StatefulWidget {
  //const failedScreenShot({Key? key}) : super(key: key);
  static const routeName = '/failedScreenshot';


  @override
  _failedScreenShotState createState() => _failedScreenShotState();
}

class _failedScreenShotState extends State<failedScreenShot> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 283.w,
                child:Text("Вибачте, але виникла проблема зі знімком екрана, який ми отримали від вас.",
              ...
              Container(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children:  <TextSpan>[
                      TextSpan(text: globalInvoiceError,style: TextStyle(
              ...
              Container(
                width: 283.w,
                child:Text("Виправте вказану проблему та знову завантажте знімок екрана.",
