...
class ref_package2 extends StatefulWidget {
  static const routeName = '/ref_package2';

  @override
  State<ref_package2> createState() => _ref_package2State();
}

class _ref_package2State extends State<ref_package2> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Перший пакет документів',//'Documents to pack',
                style: TextStyle(
             ...
             docsToSend(AppLocalizations.of(context).reportCardFor9thgrade),
              SizedBox(
                height: 20,
              ),
              docsToSend(AppLocalizations.of(context).reportCardFor10thgrade),
              SizedBox(
                height: 20,
              ),
              docsToSend(AppLocalizations.of(context).reportCardForhalfofthe11thgrade),
              SizedBox(
                height: 20,
              ),
              ...
              docsToSend(AppLocalizations.of(context).reportcardforcompletedgrade11),
              SizedBox(
                height: 30,
              ),
