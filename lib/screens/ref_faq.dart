        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: ExpansionTile(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            widget.FAQs.values.elementAt(i),
                            style: TextStyle(
                              fontSize: 14.sp,
              ...
              for (var i = 0; i < FAQ["General Questions"].length; i++)
                Container(
                  margin: EdgeInsets.only(bottom: 27.h),
                  decoration: BoxDecoration(
                    boxShadow: [
                  ...
                  child: ClipRRect(
                    ...
                    child: ExpansionTile(
                      ...
                      collapsedBackgroundColor: Colors.transparent,
                      title: Text(
                        FAQ["General Questions"].keys.elementAt(i),
                        style: TextStyle(
                            color: Color(0xff03045E),
                            fontSize: 13.sp,
                            fontWeight: FontWeight.bold,
                      ...
                      children: [
                        Container(
                          ...
                          color: Color(0xffF1F5F9),
                          child: Text(
                            FAQ["General Questions"].values.elementAt(i),
                            style: TextStyle(
                              fontSize: 14.sp,
                              color: Colors.grey.shade700,
                            ),
