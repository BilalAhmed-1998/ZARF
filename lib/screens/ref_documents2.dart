...
class ref_documents2 extends StatelessWidget {
  static const routeName = '/ref_documents2';
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ref_passport(docType:AppLocalizations.of(context).reportCardFor9thgrade ,docimg: 'assets/images/ref7.png',),
                      ));
                },
                child: Document_Card(doc: AppLocalizations.of(context).reportCardFor9thgrade,type:"upload",doc_image: reportCard9Image,doc_uploaded: reportCard9Uploaded,approvalStatus: report9Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              InkWell(
                ...
                onTap: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ref_passport(docType:AppLocalizations.of(context).reportCardFor10thgrade ,docimg: 'assets/images/ref7.png',),
                      ));
                },
                child: Document_Card(doc: AppLocalizations.of(context).reportCardFor10thgrade,type:"upload",doc_image: reportCard10Image,doc_uploaded: reportCard10Uploaded,approvalStatus: report10Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              InkWell(
                ...
                onTap: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ref_passport(docType:AppLocalizations.of(context).reportCardForhalfofthe11thgrade ,docimg: 'assets/images/ref7.png',),
                      ));
                },
                child: Document_Card(doc: AppLocalizations.of(context).reportCardForhalfofthe11thgrade,type:"upload",doc_image: HalfReportCard11Image,doc_uploaded: HalfReportCard11Uploaded,approvalStatus: HalfReport11Approved,image: 'assets/images/ref7.png'),
              ),
              ...
              InkWell(
                ...
                child: Document_Card2(doc: AppLocalizations.of(context).reportCardFor9thgrade,type:"received",docReceived: offlineReport9Received,docApproved: offlineReport9Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              InkWell(
                ...
                child: Document_Card2(doc: AppLocalizations.of(context).reportCardFor10thgrade,type:"received",docReceived: offlineReport10Received,docApproved: offlineReport10Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              InkWell(
                ...
                child: Document_Card2(doc: AppLocalizations.of(context).reportCardForhalfofthe11thgrade,type:"received",docReceived: offlineHalfReport11Received,docApproved: offlineHalfReport11Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              ...
              InkWell(
                ...
                child: Document_Card2(doc: AppLocalizations.of(context).reportcardforcompletedgrade11,type:"received",docReceived: offlineComReport11Received,docApproved: offlineComReport11Approved,image: 'assets/images/ref7.png'),
              ),
              SizedBox(
                height: 20,
              ),
              InkWell(
                enableFeedback: true,
                onTap: () {
                  Navigator.pushNamed(context, ref_package2.routeName);
                },
                child: Container(
                  decoration: BoxDecoration(
                    boxShadow: [BoxShadow(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ' Відправлений 10 днів тому',//Відправлений 10 днів тому
                                  style: TextStyle(
                                    color: Color(0xff03045E),
                                    fontSize: 11,
                                    fontFamily: ('Inter'),
